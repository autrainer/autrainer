...
* Global default parameters for :ref:`training <training>`, such as the evaluation frequency, save frequency, inference batch size, CUDA-enabled device,
  controlling :ref:`reproducibility <guide_reproducibility>`, etc.
